...
class ControllerConfig(BaseModel):
    ...
    mumble_host: Optional[str] = Field(default=None, description="Mumble server host (default: 127.0.0.1)")
    mumble_protocol: Optional[str] = Field(default=None, description="Mumble protocol: 'ice' or 'grpc' (default: ice)")
    mumble_ice_port: Optional[int] = Field(default=None, description="Mumble ICE port (default: 6502)")
    mumble_secret: Optional[str] = Field(default=None, description="Mumble ICE secret (icesecretwrite in murmur.ini)")
